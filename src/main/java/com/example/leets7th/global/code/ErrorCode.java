...
public enum ErrorCode implements BaseCode {
    ...
    TOKEN_EXPIRATION(HttpStatus.UNAUTHORIZED,"AUTH401_2","인증 토큰이 만료되었습니다."),
    TOKEN_INVALIDATION(HttpStatus.UNAUTHORIZED,"AUTH_401_3","인증 토큰이 올바르지 않습니다"),
    RT_NOT_EXISTS(HttpStatus.UNAUTHORIZED,"AUTH404_1","인증 토큰이 존재하지 않습니다."),
    LOGIN_NOT_VALID(HttpStatus.BAD_REQUEST,"AUTH_400_1","아이디 또는 비밀번호가 올바르지 않습니다."),
