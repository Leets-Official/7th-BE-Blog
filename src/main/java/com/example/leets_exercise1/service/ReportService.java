...
public interface ReportService {
    ...
    ReportCreateResponse reportPost(Integer postId, PostReportCreateRequest request);

    ReportCreateResponse reportComment(Integer commentId, CommentReportCreateRequest request);

    ReportResolveResponse resolveReport(Integer reportId);
}