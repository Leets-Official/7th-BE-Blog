...
public class ReportServiceImpl implements ReportService {
    ...
    @Override
    @Transactional
    public ReportCreateResponse reportPost(Integer postId, PostReportCreateRequest request) {
    ...
    @Override
    @Transactional
    public ReportCreateResponse reportComment(Integer commentId, CommentReportCreateRequest request) {
    ...
    @Override
    @Transactional
    public ReportResolveResponse resolveReport(Integer reportId) {
